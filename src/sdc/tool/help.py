...
from sdc.registry import available_readers, available_filters, available_writers, available_generators, available_data_formatters, available_cleaners

HELP = "sdc-help"

_logger = logging.getLogger(HELP)

INDEX_TITLE_DEFAULT = "spectral-data-converter plugins"
...
def main(args=None):
    ...
    :type args: list
    """
    init_logging(env_var=ENV_SDC_LOGLEVEL)
