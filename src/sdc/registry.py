...
ENV_SDC_CLASS_LISTERS = "SDC_CLASS_LISTERS"

# environment variable with comma-separated list of class listers to exclude
ENV_SDC_CLASS_LISTERS_EXCL = "SDC_CLASS_LISTERS_EXCL"

# the default class listers to inspect (for development)
# can be overridden with SDC_CLASS_LISTERS environment variable
DEFAULT_SDC_CLASS_LISTERS = [
    "sdc.class_lister",
]
